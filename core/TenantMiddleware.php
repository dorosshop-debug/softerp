...
class TenantMiddleware
{
    ...
    {
        $admin = [
            'modules' => ['dashboard', 'caja', 'ventas', 'inventario', 'clientes', 'proveedores', 'cotizaciones', 'gastos', 'reportes', 'configuracion'],
            'actions' => ['create', 'edit', 'delete', 'view', 'export'],
        ];
        $manager = [
            'modules' => ['dashboard', 'caja', 'ventas', 'inventario', 'clientes', 'proveedores', 'cotizaciones', 'gastos', 'reportes'],
            'actions' => ['create', 'edit', 'delete', 'view', 'export'],
        ];

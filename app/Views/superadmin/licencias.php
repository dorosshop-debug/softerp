                        ...
                        <?php foreach ($sales as $sale): ?>
                            <tr>
                                ...
                                <td class="table-actions">
                                    ...
                                    <button onclick="editLicense(<?php echo $sale['id']; ?>, <?php echo $sale['tenant_id'] ?? 'null'; ?>, <?php echo $sale['plan_id']; ?>, '<?php echo $sale['sale_date']; ?>', '<?php echo $sale['start_date']; ?>', '<?php echo $sale['billing_cycle']; ?>', '<?php echo $sale['payment_status']; ?>', '<?php echo $sale['payment_method']; ?>', '<?php echo htmlspecialchars($sale['notes'] ?? '', ENT_QUOTES); ?>', '<?php echo $sale['status']; ?>')" class="btn btn-purple" title="Editar venta">Editar</button>
